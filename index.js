...
function getLastReview(tArray) 
{
  let lri = tArray.length - 1;
  return tArray[lri].name + " gave the restaurant a " + tArray[lri].rating + " star review, and their feedback was: " + tArray[lri].feedback;
} 
